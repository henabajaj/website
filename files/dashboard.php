...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Ink Screen | Dashboard</title>
...
<!--                        <small>dashboard & statistics</small>-->
                    ...
                    <div class="row">
<?php
                        $icons = array("fa-user","fa-book","fa-cart-plus");
                        $card_text =array("Number of Users","Number of Books","Number of Requests",);
                        $value = array("500","700","32");
                        $color = array("purple","red","yellow");
